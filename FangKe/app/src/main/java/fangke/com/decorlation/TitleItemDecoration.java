package fangke.com.decorlation;
...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    private List<? extends CityBean> mDatas;
    ...
    public TitleItemDecoration(Context context, List<? extends CityBean> datas) {
        ...
        mPaint = new Paint();
        mBounds = new Rect();
        //context.getResources().getDisplayMetrics()获取的是手机屏幕信息
        mTitleHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 30, context.getResources().getDisplayMetrics());//方法是获取你想转换后的数值大小 ，这里第一个参数是想要换的数据类型，第二个参数是值。
